//arrays/JSON com a lista das pizzas
let pizzaJson = [
    {id:1, name:"Mussarela", img:'images/pizza.png', price:21.99, sizes:['100g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    ...
    {id:5, name:"Sorvete", img:'images/pizza5.png', price:23.50, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    ...
    {id:7, name:"Chocolate", img:'images/pizza7.png', price:22.35, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
];
